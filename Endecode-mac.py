...
window.title('编码/解码工具 @huayang V1.0')
...
def getValue():
    if bookChosen.get() == 'base64':
        ...
        scr1 = scrolledtext.ScrolledText(tab1,width=50, height=38, font=(1))
    ...
    if bookChosen.get() == 'base32':
        ...
        scr3 = scrolledtext.ScrolledText(tab1,width=50, height=38, font=(1))
    ...
    if bookChosen.get() == 'base16':
        ...
        scr5 = scrolledtext.ScrolledText(tab1,width=50, height=38, font=(1))
...
scr1_MD5 = scrolledtext.ScrolledText(tab2, width=50, height=38, font=(1))
...
scr1 = scrolledtext.ScrolledText(tab3, width=90, height=6, font=(1))
scr1.place(x=0, y=35)

scr2 = scrolledtext.ScrolledText(tab3, width=90, height=7, font=(1))
scr2.place(x=0, y=180)

scr3 = scrolledtext.ScrolledText(tab3, width=90, height=7, font=(1))
scr3.place(x=0, y=335)

scr4 = scrolledtext.ScrolledText(tab3, width=90, height=7, font=(1))
...
scr1_url = scrolledtext.ScrolledText(tab4, width=50, height=38, font=(1))
...
scr1_json = scrolledtext.ScrolledText(tab5,width=50, height=38, font=(1))
...
#基本型
    if bookChosen3.get() == '基本型':
        ...
        scr1_hex = scrolledtext.ScrolledText(tab6,width=50, height=38, font=(1))
...
#加上0x
    if bookChosen3.get() == '加上0x':
        ...
        scr3_hex = scrolledtext.ScrolledText(tab6,width=50, height=38, font=(1))
...
#加上%编码
    if bookChosen3.get() == '加上%':
        ...
        scr5_hex = scrolledtext.ScrolledText(tab6,width=50, height=38, font=(1))
...
#加上\x编码
    if bookChosen3.get() == '加上\\x':
        ...
        scr7_hex = scrolledtext.ScrolledText(tab6,width=50, height=38, font=(1))
...
#八进制
    if bookChosen4.get() == '八进制':
        ...
        scr1_hex = scrolledtext.ScrolledText(tab7,width=50, height=38, font=(1))
